...
\pagebreak
\section{Android XML}
 Each element in the layout file stands for something that will be displayed on screen. The activity details are specified at the top and then everything is inside a container layout like a FlowLayout our LinearLayout. The element can then be pro-grammatically fetched and used within the class to specify how it should act with an action. Below is an example of a layout class that was used for the about page section of the application.
